...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-100 dark:bg-[#111] text-gray-600 dark:text-gray-400">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo and description */}
          <div className="col-span-1 md:col-span-1">
            <div className="text-primary font-bold text-2xl mb-4">EduTrack</div>
            <p className="text-sm">
              A platform for conscious student development, powered by AI to enhance learning experiences.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/demo" className="text-sm hover:text-primary">
                  Request Demo
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/careers" className="text-sm hover:text-primary">
                  Careers
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/compliance" className="text-sm hover:text-primary">
                  Compliance
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">
            &copy; {currentYear} EduTrack. {t('footer.rights')}
          </p>
